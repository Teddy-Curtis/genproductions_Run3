...
os.makedirs(f"tmp/base_{process}_mH{mH}_mA{mA}_mHch{mHch}", exist_ok=True)
os.chdir(f"tmp/base_{process}_mH{mH}_mA{mA}_mHch{mHch}")
...
custom_card_loc = f"{base_dir}/{process}_mH{mH}_mA{mA}_mHch{mHch}/{process}_mH{mH}_mA{mA}_mHch{mHch}_customizecards.dat"
...
with open(f'{base_dir}/{process}_mH{mH}_mA{mA}_mHch{mHch}/{process}_mH{mH}_mA{mA}_mHch{mHch}_customizecards.dat', 'w') as f:
    f.write(set_commands)
